...
from src.environments.flappy_bird import FlappyBird, FlappyBirdConfig
from src.environments.lunar_lander import LunarLander, LunarLanderConfig


def create_environment(env_config: CarRacingConfig | ConnectFourConfig | LunarLanderConfig | FlappyBirdConfig, device: DeviceLikeType = "cpu") -> Environment:
    match env_config:
        ...
        case FlappyBirdConfig():
            return FlappyBird(env_config, device)
        case _:
