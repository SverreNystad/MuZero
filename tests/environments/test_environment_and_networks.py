...
def test_lunar_lander_states_with_representation_network():
    env: Environment = create_environment(LunarLanderConfig())

    latent_shape = (6, 6, 3)
    repr_net = tiny_repr_net(latent_shape=latent_shape, observation_space=env.get_observation_space(), downsample=False)
