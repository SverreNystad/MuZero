...
def tiny_dyn_net():
    ...
    """
    return DynamicsNetwork(latent_dim=2, num_actions=2)
...
def tiny_pred_net():
    ...
    latent_dim=2, num_actions=2
    """
    return PredictionNetwork(latent_dim=2, num_actions=2)
...
def test_single_update(
    minimal_config, tiny_repr_net, tiny_dyn_net, tiny_pred_net, single_step_episode
):
    """
...
def test_no_valid_rollout(minimal_config, tiny_repr_net, tiny_dyn_net, tiny_pred_net):
    """
